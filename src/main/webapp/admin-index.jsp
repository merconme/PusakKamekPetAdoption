...
<%@ page import="com.pusakkamek.dao.PetDAO, com.pusakkamek.dao.CategoryDAO" %>
<%@ page import="com.pusakkamek.model.Pet, com.pusakkamek.model.Category" %>
<%@ page import="java.util.List" %>
<%
    // Fetch categories and pets from database
...
<head>
    ...
    <style>
        ...
        .navbar { display: flex; justify-content: space-between; align-items: center; padding: 0 5%; height: 80px; background: white; position: fixed; top: 0; left: 0; width: 100%; z-index:1000; box-shadow: var(--shadow);}
        ...
        .btn-back { background: rgba(255, 255, 255, 0.2); color:white; padding:8px 15px; border-radius:10px; text-decoration:none; font-size:13px; font-weight:600; display:flex; align-items:center; gap:8px; transition:0.3s; border:1px solid rgba(255,255,255,0.3); margin-bottom:20px; width:fit-content;}
...
<body>
    ...
    <div class="modal-overlay" id="petModal">
        <div class="modal-content">
            ...
            <form class="form-grid" action="AddPetServlet" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group"><label>Age</label><input type="text" name="age" placeholder="e.g. 1 Year" required></div>
                <div class="form-group"><label>Breed</label><input type="text" name="breed" placeholder="e.g. Persian" required></div>
                <div class="form-group"><label>Photo</label><input type="file" name="photo"></div>
                <button class="submit-btn" type="submit">Save Pet Entry</button>
            </form>
        </div>
    </div>
    ...
    <div class="modal-overlay" id="categoryModal">
        <div class="modal-content" style="max-width:500px; flex-direction:column; align-items:center; text-align:center;">
            ...
            <form style="width:100%;" action="AddCategoryServlet" method="post" enctype="multipart/form-data">
                <div class="upload-placeholder" style="margin-bottom:20px;">
                    ...
                    <input type="file" name="photo" required style="opacity:0; position:absolute; width:160px; height:160px; cursor:pointer;">
                </div>
                ...
                <button class="submit-btn" type="submit" style="width:100%;">Create Category</button>
            </form>
        </div>
    </div>
